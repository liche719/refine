...
CREATE TABLE `knowledgePoint` (
                                  ...
                                  `knowledge_point_id` varchar(20) COMMENT '知识点唯一标识ID',
                                  `parent_knowledge_point_id` varchar(20) DEFAULT NULL COMMENT '逻辑外键：父知识点ID（关联本表id，顶级知识点为NULL）',
                                  `son_knowledge_point_id` varchar(20) DEFAULT NULL COMMENT '逻辑外键：子知识点ID（关联本表id，无下级为NULL）',
...
CREATE TABLE `MistakeQuestion` (
                                   ...
                                   `knowledge_point_id` varchar(20) COMMENT '逻辑外键：关联knowledge_point表的knowledge_point_id',
